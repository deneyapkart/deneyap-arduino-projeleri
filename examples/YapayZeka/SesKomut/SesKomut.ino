 ...
 *  Deneyap Kart dahili mikrofonunda algınan "yes" ve "no" kelimelerini yapay zeka algoritmasıyla algılayıp seri port ekranına 
 *  "yes" , "no" , "silence" ve "unknown" yazdırmaktadır.  
 *
 *  ==============================================================================
